...
class Graph
 {int [][] a; int n;
  Graph() {}
  //----------------------------------------
  void setData(String fname) throws IOException
   {int i,j;
    String s="", s1="";
    StringTokenizer t;
    RandomAccessFile f; 
  ...
  void writeAdjListToFile(String fname) throws IOException
   {if(n==0) setData("matrix.txt");
    ...
    f.writeBytes(m + "\n");
    for(i=0;i<m;i++) q[i].writeToFile(f);
    f.close();
   }
 }
//=======================================================
   ...
   {Scanner s = new Scanner(System.in);
    ...
    while(true)
      {System.out.println("\n Choose your option:");
       ...
       System.out.println("  4. Write adjacency list to file");
       ...
       switch(choice)
        {case 1:  g.setData("matrix.txt");
         ...
         case 3:  g.displayAdjacency();
                  g.displayAdjList();
                  break;
         case 4:  g.writeAdjListToFile("AdjList.txt");
                  break;
